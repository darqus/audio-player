...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(div2, "class", "track-name");
			attr(path0, "d", paths.previousLeft);
			attr(path1, "d", paths.previousRight);
			attr(svg0, "xmlns", "http://www.w3.org/2000/svg");
			attr(svg0, "viewBox", VIEW_BOX);
			attr(button0, "aria-label", "Previous Track");
			attr(path2, "d", path2_d_value = /*isPlaying*/ ctx[1] ? paths.pauseLeft : paths.play);
			attr(svg1, "xmlns", "http://www.w3.org/2000/svg");
			attr(svg1, "viewBox", VIEW_BOX);
			attr(button1, "aria-label", button1_aria_label_value = /*isPlaying*/ ctx[1] ? 'Pause' : 'Play');
			attr(path3, "d", paths.nextLeft);
			attr(path4, "d", paths.nextRight);
			attr(svg2, "xmlns", "http://www.w3.org/2000/svg");
			attr(svg2, "viewBox", VIEW_BOX);
			attr(button2, "aria-label", "Next Track");
			attr(path5, "d", paths.shuffle);
			attr(svg3, "xmlns", "http://www.w3.org/2000/svg");
			attr(svg3, "viewBox", VIEW_BOX);
			attr(button3, "class", button3_class_value = /*shuffle*/ ctx[3] ? '' : 'shuffle');
			attr(button3, "aria-label", "Shuffle");
			attr(path6, "d", paths.repeatLeft);
			attr(path7, "d", paths.repeatRight);
			attr(svg4, "xmlns", "http://www.w3.org/2000/svg");
			attr(svg4, "viewBox", VIEW_BOX);
			attr(button4, "class", button4_class_value = /*repeat*/ ctx[4] ? '' : 'repeat');
			attr(button4, "aria-label", "Repeat");
			attr(div3, "class", "buttons-control");
			attr(div4, "class", "current-time");
			...
			attr(div5, "class", "duration-time");
			attr(div6, "class", "progress-control");
			...
			attr(svg5, "viewBox", VIEW_BOX);
			attr(button5, "aria-label", button5_aria_label_value = /*isMuted*/ ctx[2] ? 'Unmute' : 'Mute');
			attr(input1, "type", "range");
			attr(input1, "min", "0");
			attr(input1, "max", "1");
			attr(input1, "step", "0.01");
			input1.value = /*volume*/ ctx[7];
			attr(div7, "class", "volume-control");
			attr(div8, "class", "track-ranges");
			attr(div9, "class", "track-info");
			attr(div10, "class", "svelte-audio-player");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*isPlaying*/ 2 && button1_aria_label_value !== (button1_aria_label_value = /*isPlaying*/ ctx[1] ? 'Pause' : 'Play')) {
				attr(button1, "aria-label", button1_aria_label_value);
			}

			if (dirty & /*shuffle*/ 8 && button3_class_value !== (button3_class_value = /*shuffle*/ ctx[3] ? '' : 'shuffle')) {
				attr(button3, "class", button3_class_value);
			}

			if (dirty & /*repeat*/ 16 && button4_class_value !== (button4_class_value = /*repeat*/ ctx[4] ? '' : 'repeat')) {
			...
			if (dirty & /*isMuted*/ 4 && button5_aria_label_value !== (button5_aria_label_value = /*isMuted*/ ctx[2] ? 'Unmute' : 'Mute')) {
